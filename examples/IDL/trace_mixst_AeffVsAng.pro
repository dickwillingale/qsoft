...
cgDISPLAY,768*2,512*2
;!P.multi=[0,3,2]
Aeff = FLTARR(N_ELEMENTS(offang))
FOR i = 0,N_ELEMENTS(offang)-1 DO BEGIN
...
; create image
  ...
  Aeff(i) = TOTAL(a.data_array)
  PRINT,offang(i), Aeff(i)
ENDFOR
plot_area = PLOT(offang, Aeff)

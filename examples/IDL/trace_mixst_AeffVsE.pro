...
nrgs = (FINDGEN(100)+1)*8./100.
Aeff = FLTARR(N_ELEMENTS(nrgs))
FOR ee = 0,N_ELEMENTS(nrgs) - 1 DO BEGIN
  ...
  ENDFOR
  Aeff(ee) = TOTAL(a.data_array)
  PRINT,ekev, Aeff(ee)
ENDFOR
plot_area = PLOT(nrgs, Aeff)

*+AX_DTCOR provides barycentric and heliocentric corrections
	SUBROUTINE AX_DTCOR(DMJD,RA,DEC,SECH,SECB)
	IMPLICIT DOUBLE PRECISION (D)
	DOUBLE PRECISION DMJD
	DOUBLE PRECISION RA,DEC,SECH,SECB
*DMJD      Input  MJD

*+SRT_SU6      Intersection of ray with surface type 6
        SUBROUTINE SRT_SU6(IP,IDEF,ORG,DIR,HIT,POS,RNM,ISTAT)
...
*Type 6 is a plane with normal deformation and radial limits

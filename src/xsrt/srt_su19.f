*+SRT_SU19      Intersection of ray with surface type 19
        SUBROUTINE SRT_SU19(IP,IDEF,ORG,DIR,HIT,POS,RNM,ISTAT)
...
*Type 19 is a conic at grazing incidence with radial deformation
* and axial and azimuthal limits
...
* (1) maximum azimuth
*-Author Dick Willingale 2002-Jul-1
	INCLUDE 'SRT_COM'
C Check status

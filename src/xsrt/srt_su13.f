*+SRT_SU13      Intersection of ray with surface type 13
        SUBROUTINE SRT_SU13(IP,IDEF,ORG,DIR,HIT,POS,RNM,ISTAT)
...
*Type 13 is a sphere at grazing incidence with radial deformation
* and radial limits

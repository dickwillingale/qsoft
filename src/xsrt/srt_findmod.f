*+SRT_FINDMOD    Find module aperture
	SUBROUTINE SRT_FINDMOD(XR,YR,MHIT,RM,PM,TM,WM,HM,LM,CM,GM,XX,YY)
	IMPLICIT NONE
      	INTEGER MHIT
	DOUBLE PRECISION XR,YR,RM,PM,TM,WM,HM,LM,XX,YY
	DOUBLE PRECISION CM,GM
...
*CM	output	axial curvature signature of module
...
C Dimensions of module aperture
		ELW=wlist(ITRY)*0.5
		ELH=hlist(ITRY)*0.5
		IF(iptype.EQ.1.or.iptype.EQ.3) THEN

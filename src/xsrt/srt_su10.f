*+SRT_SU10      Intersection of ray with surface type 10
        SUBROUTINE SRT_SU10(IP,IDEF,ORG,DIR,HIT,POS,RNM,ISTAT)
...
*Type 10 is a conic at normal incidence with axial deformation
* and radial limits

...
Cf2py  intent(in) XX,CREFIN,PERFCT,MINCUT,ANYANG,NUMANG,XMU,NMOM
Cf2py  intent(in) IPOLZN,MOMDIM,PRNT
Cf2py  intent(out) QEXT,QSCA,GQSC,S1,S2,SFORW,SBACK,TFORW,TBACK
Cf2py  intent(out) SPIKE,PMOM
...
c ----------------------------------------------------------------------
     ...
     &         XMU(NUMANG), XX
      COMPLEX  CREFIN,SFORW,SBACK,S1(NUMANG),S2(NUMANG)
